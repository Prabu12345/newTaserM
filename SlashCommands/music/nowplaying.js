...
module.exports = {
  ...
  execute: async (client, interaction) => {
    try {
        ...
        interaction.reply({
            embeds: [
                new MessageEmbed().setColor(config.normalColor)
                ...
                .addField(`Queue:`, `>>> ${newQueue.songs.length} song(s) - ${newQueue.formattedDuration}`, true)
                .addField(`Volume:`, `>>> ${newQueue.volume}%`, true)
                .addField(`Loop:`, `>>> ${newQueue.repeatMode ? newQueue.repeatMode === 2 ? `:white_check_mark: Queue` : `:white_check_mark: Song` : `:x:`}`, true)
                .addField(`Autoplay:`, `>>> ${newQueue.autoplay ? `:white_check_mark: ` : `:x:`}`, true)
                ...
                .addField(`Like${newTrack.likes > 0 ? "s": ""}:`, `>>> ${newTrack.likes}`, true)
                .addField(`Dislike${newTrack.dislikes > 0 ? "s": ""}:`, `>>> ${newTrack.dislikes}`, true)
